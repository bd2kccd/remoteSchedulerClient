...
/**
 * Author : Jeremy Espino MD Created 4/1/16 11:50 AM Author : Chirayu (Kong)
 * Wongchokprasitti, PhD Modified 6/21/16 2:21 PM
 */
public class SlurmClient implements SchedulerClient {
    ...
    /**
     * @param dataDirTemplateName - the velocity template filename that will be
     * found in configuration's template path
    ...
    /**
     * @param jobTemplateName - the velocity template filename that will be
     * found in configuration's template path
     * @param jobProperties
     * @param remoteScriptFileName
    ...
    private List<JobStat> sacctResult2JobStats(String s) {
         ...
         * ------------ ---------- ---------- ---------- -------------------
         * ------------------- ---------- ---------- 138330 RM COMPLETED
         * 00:00:02 2016-06-08T16:50:17 2016-06-08T16:50:19 28 1 138330.batch
         * COMPLETED 00:00:02 2016-06-08T16:50:17 2016-06-08T16:50:19 28 1
         *
         */
    ...
    private List<JobStatus> sacctResult2JobStatuses(String s) {
         ...
         * ------------ ---------- ---------- --------- ---------- ----------
         * -------- --------------- 135524 RM causal-cm+ chirayu COMPLETED
         * 00:00:01 1 r017 135524.batch batch COMPLETED 00:00:01 1 r017
         *
         */
    ...
    private List<JobStatus> str2JobStatuses(String s) {
        /**
         * JOBID PARTITION NAME USER ST TIME NODES NODELIST(REASON) 111189 LM
         * run_RM2_ sczyrba R 9:15:49 1 l004
         */
